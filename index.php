...
$hint = array(
    ...
    "2.3" => "画像の大きさが間違ってませんか？(要バイナリエディタ)"
    		."<a href='https://www.tohoho-web.com/wwwgif.htm'>参考資料</a>" ,
    // Web技術系
    ...
    "5.2" => "インターネットに個人情報つき画像を掲載するのは危険です。食べたい物はドメイン名(英字)に書いてあるよ" ,
    // OS系
...
$thanx = array(
    ...
    "3.6" => "UserAgentをつかうとスマホ専用のページなどを作ることができます。" ,
    // プログラム作成系
